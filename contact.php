...
<html lang="fr">
  ...
  <table>
      ...
      <td>
        ...
        <input type="radio" name="civilite" value="Monsieur" id="Civilite">
        <label for="Civilite">Madame</label>
        <input type="radio" name="civilite" value="Madame" id="Civilite">
      </td>
    </tr></br>
    <tr>
      <td>Votre nom :</td>
    ...
    <tr>
      ...
      <td><input type="email" required></td></br>
    <tr>
      <td>Votre message :</td>
      <td><input type= "text" size="500" required></td>
  </table>
	</div>
	<div id=contenu>
